...
int main(int argc, const char* argv[]) {
  ...
  try {
    ...
    BOOST_LOG_TRIVIAL(info) << boost::log::add_value(logging::additional_data, start_data)
                            << "server started";
  ...
  BOOST_LOG_TRIVIAL(info) << boost::log::add_value(logging::additional_data, exit_data)
                          << "server exited";
